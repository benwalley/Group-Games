...
export default function GamingSessionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setLastPlayedTime(initialValues.lastPlayedTime);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new GamingSession(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "GamingSessionCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
